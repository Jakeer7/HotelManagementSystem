		...
		<div class="navbar navbar-inverse">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="/show-userss">Customer Update</a></li>
					<li><a href="/show-user">Room Booking</a></li>
					<li><a href="/show-user">Vacancy Rooms</a></li>
					<li><a href="/show-user">Billing Details</a></li>
